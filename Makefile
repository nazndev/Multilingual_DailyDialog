.PHONY: venv install translate build-sft train-demo train-final train-3b train-7b eval-demo eval-final eval-3b eval-7b judge-7b-3b-vs-gemma pipeline-demo pipeline-final
